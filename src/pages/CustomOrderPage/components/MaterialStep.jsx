...
import { SkeletonMaterialCard, SkeletonRadioButton } from './SkeletonCard';
    ...
    <div>
      ...
      <div className="flex items-start gap-6 mb-8">
        {isLoading || materials.length === 0
          ? // Skeleton — 2 placeholder material cards
      ...
      {selectedMaterial && (
        <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          {isThicknessLoading ? (
            // Skeleton — 3 placeholder radio pills
            <div className="flex flex-wrap gap-4">
              {Array.from({ length: 3 }).map((_, i) => (
                <SkeletonRadioButton key={i} />
              ))}
            </div>
